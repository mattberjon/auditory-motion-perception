...
# -*- coding: utf-8 -*-
#
# Auditory Motion Perception documentation build configuration file, created by
...
project = 'Auditory Motion Perception'
...
htmlhelp_basename = 'AuditoryMotionPerceptiondoc'
